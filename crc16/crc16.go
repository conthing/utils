...
func CRC16(data []byte, tab *Table) uint16 { return Update(0, tab, data) }

// CRC16IBM returns the CRC-16 checksum of data
// using the IBM polynomial.
func CRC16IBM(data []byte) uint16 { return Update(0, IBMTable, data) }

// CRC16MODBUS returns the CRC-16 checksum of data
// using the IBM polynomial.
func CRC16MODBUS(data []byte) uint16 { return ^Update(0, IBMTable, data) }

// CRC16CCITTFalse returns the CRC-16 checksum using
// what some call the CCITT-False polynomial, which matches what is used
// by Perl Digest/CRC and Boost for example.
func CRC16CCITTFalse(data []byte) uint16 { return Update(0xffff, CCITTFalseTable, data) }

// CRC16XMODEM returns the CRC-16 checksum using
// what some call the CCITT-False polynomial, which matches what is used
// by Perl Digest/CRC and Boost for example.
func CRC16XMODEM(data []byte) uint16 { return Update(0, CCITTFalseTable, data) }

// CRC16CCITT returns the CRC-16 checksum of data
// using the CCITT polynomial.
func CRC16CCITT(data []byte) uint16 { return Update(0, CCITTTable, data) }

// CRC16SCSI returns the CRC-16 checksum of data
// using the SCSI polynomial.
func CRC16SCSI(data []byte) uint16 { return Update(0, SCSITable, data) }

// CRC16MBus returns the CRC-16 checksum of data
// using the MBus polynomial.
func CRC16MBus(data []byte) uint16 { return Update(0, MBusTable, data) }
